-- 1. Perbaiki fungsi create_teacher_user untuk menyertakan auth.identities
-- Supabase GoTrue WAJIB memiliki record di auth.identities agar user bisa login.
...
BEGIN
    ...
    -- 2. Insert ke auth.identities (WAJIB UNTUK LOGIN SUPABASE)
...
-- 2. Tambahkan auth.identities untuk user yang mungkin terlewat
